...
export default function LeaderboardPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col items-center px-4 py-8">
      ...
      <Link
        href="/"
        className="mb-6 text-sm text-neutral-500 hover:text-white border border-neutral-800 hover:border-neutral-600 px-4 py-2 rounded-lg transition-colors"
      >
        &larr; back to voting
      </Link>

      {loading ? (
        <div className="text-neutral-500 animate-pulse text-lg">loading...</div>
      ) : punks.length === 0 ? (
