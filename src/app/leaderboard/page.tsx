...
export default function LeaderboardPage() {
  ...
  const tabClass = (t: Tab) =>
    `text-sm px-4 py-2 rounded-lg transition-colors cursor-pointer ${
      tab === t
        ...
        {tab === "traits" && (
          <>
            {hasLoaded && traits.length === 0 ? (
              ...
              <>
                {/* Column headers */}
                <div className="grid grid-cols-[2rem_1fr_4rem_3.5rem_3.5rem] gap-x-3 items-center text-xs text-neutral-500 mb-2 px-3">
                  <span className="text-right">#</span>
                  <span>trait</span>
                ...
                <div className="flex flex-col gap-1" style={{ minHeight: 400 }}>
                  {traits.map((trait, i) => (
                    <div
                      key={trait.trait}
                      className="grid grid-cols-[2rem_1fr_4rem_3.5rem_3.5rem] gap-x-3 items-center px-3 py-2 rounded-lg bg-neutral-900/50 hover:bg-neutral-800/50 transition-colors"
                    >
                      <span className="text-neutral-600 text-sm text-right">
                        {i + 1}
                      </span>
